...
order=1
threshold=0.05
useMahony=False ##是否適用mahony重算quaternion
useMag=False ##是否使用磁力計
useMadgwick=False
singlelevel=True
caliACC=False
...
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/2/Roy62E24_9axis_220629.csv'
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/3/Roy62E24_9axis_220629.csv'
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/4/Roy62E24_9axis_220629.csv'
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/5_2/Roy62E24_9axis_220629.csv'

# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/6/Roy62E24_9axis_220629.csv'
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/7/Roy62E24_9axis_220629.csv'
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/8/Roy62E24_9axis_220629.csv'

# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/AroomNoDistortion/Roy62E24_9axis_220630.csv'

# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/AroomNoDistortion2/Roy62E24_9axis_220630.csv'

# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/AroomNoDistortion3/Roy62E24_9axis_220630_1.csv'
...
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/2/Roy62E24_quater_220629.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/3/Roy62E24_quater_220629.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/4/Roy62E24_quater_220629.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/5_2/Roy62E24_quater_220629.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/6/Roy62E24_quater_220629.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/7/Roy62E24_quater_220629.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/220629exp8in1/8/Roy62E24_quater_220629.csv' #r2 

# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/AroomNoDistortion/Roy62E24_quater_220630.csv' #r2 

# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/AroomNoDistortion2/Roy62E24_quater_220630.csv' #r2 
# pathway=Reader.get_UpperPath('.')+'/Gait-Tracking-With-x-IMU-Python-master/AroomNoDistortion3/Roy62E24_quater_220630_1.csv' #r2 
Reader.figure(path=pathway)
raw=Reader.export()
ts2=raw[:,0]
ts2[ts2<ts2[0]]+=65536
